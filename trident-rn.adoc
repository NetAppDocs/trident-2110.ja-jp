...
以前のリリースについては、を参照してください https://docs.netapp.com/us-en/trident/earlier-versions.html["ドキュメントの ealier バージョン"]。



=== Astra Trident 21.10.0 以降の変更点
